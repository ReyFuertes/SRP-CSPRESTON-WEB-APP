...
@Component({
  selector: 'app-referral-types',
  templateUrl: './referral-types.component.html'
})

export class ReferralTypesComponent implements OnInit {
  ...
  public updateCategory(form: NgForm) {
    ...
    this
    .categoryService
    .updateReferralType(form.value, this.category.id)
    .subscribe(
      (res) => {
        this.listCategories();
  ...
  public deleteCategory(category) {
    ...
    this
    .categoryService
    .deleteReferralType(this.category.id)
    .subscribe(
      (res) => {
        this.listCategories();
        this.closeDelete();
