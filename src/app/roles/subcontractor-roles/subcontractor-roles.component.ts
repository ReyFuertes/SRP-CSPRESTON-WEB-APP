...
@Component({
  selector: 'app-subcontractor-roles',
  templateUrl: './subcontractor-roles.component.html'
})

export class SubcontractorRolesComponent implements OnInit {
  ...
  public updateRole(form: NgForm) {
    ...
    this
        .roleService
        .updateSubcontractorRole(form.value, this.role.id)
        .subscribe(
            (res) => {
              this.listRoles();
  ...
  public deleteRole(role) {
    this
        .roleService
        .deleteSubcontractorRole(this.role.id)
        .subscribe(
            (res) => {
              this.listRoles();
              this.closeDelete();
